...
public interface EmployeeRepository extends JpaRepository <Employee, Long> {
    ...
    List<ReportingDTO> findAllEntranceLogsBetweenDates(@Param("startDate") LocalDate startDate, @Param("endDate") LocalDate endDate);
    ...
    List<ReportingDTO> findAllEntranceLogsBetweenDatesForGivenEmployeeId(@Param("id") Long id, @Param("startDate") LocalDate startDate, @Param("endDate") LocalDate endDate);
